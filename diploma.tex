...
\subsection{Uporaba šifer v oblaku}

Uvod, encryption at rest, in transit

\subsubsection{SSL in TLS}

\subsubsection{Server-side encryption}

\subsubsection{Client-side encryption}

\subsubsection{Homomorfne šifre}
